...
public class SeedsTest {
    ...
    public static void prepareData() throws IOException {
        Files.readAllLines(Paths.get("/Users/sunweipeng/development/source/KMeans/src/seeds.data")).size();
        System.out.println("xxx");
        System.out.println(Files.readAllLines(Paths.get("/Users/sunweipeng/development/source/KMeans/src/seeds.data")).size());
        dataSet = Files.readAllLines(Paths.get("/Users/sunweipeng/development/source/KMeans/src/seeds.data")).stream().map(new Function<String, PointWithLabel>() {
            @Override
    ...
    public static void main(String[] args) throws IOException {
      ...
      /*  //初始化一个Kmean对象，将k置为10
        for(int desenity=45;desenity<150;desenity++) {
